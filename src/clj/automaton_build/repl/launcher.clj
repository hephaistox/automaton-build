...
(defn default-middleware
  ...
  []
  (let [cider-middlewares (build-namespace/try-require 'cider.nrepl/cider-middleware)
        nrepl-middleware (build-namespace/try-require 'refactor-nrepl.middleware/wrap-refactor)]
    (cond-> []
